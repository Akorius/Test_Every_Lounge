import 'package:everylounge/presentation/widgets/shared/payment_area/alfa/alfa_pay_button.dart';
...
class AlfaPayArea extends StatelessWidget {
  final int? passesCount;
  final num price;
  final bool canPress;
  final bool loading;
  final Function() onAflaPayPressed;
  ...
  const AlfaPayArea({
    ...
    this.passesCount,
    required this.price,
    required this.onAflaPayPressed,
