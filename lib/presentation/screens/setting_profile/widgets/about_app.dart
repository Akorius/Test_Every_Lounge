...
import 'package:everylounge/presentation/screens/setting_profile/widgets/gesture_detector.dart';
            ...
            child: BlocBuilder<ProfileSettingsCubit, ProfileSettingsState>(
              builder: (context, state) {
                return ListView.builder(
                    ...
                    return Theme(
                      ...
                      child: GestureDetectorButton(
                        ...
                        child: ListTile(
                          ...
                          trailing: (!PlatformWrap.isWeb && (index == 0 || index == 1))
                              ? Icon(
                              ...
                              : Text(
                                  (index == 2 || (PlatformWrap.isWeb && index == 0)) ? (version ?? '') : 'Prod',
                                  style: AppTextStyles.textLargeRegular(
                                    color: context.colors.textNormalGrey,
                                  ),
                                ),
                  ...
                  itemCount: state.isDeveloper ? title.length : title.length - 1,
                );
              },
            ),
          ),
